...
class HardTests1 extends StatelessWidget {
  const HardTests1({super.key});

  @override
  Widget build(BuildContext context) {
    return const ReusableHardTests(
      pageTitle: "Test 1",
      textTitle: "The Evolution of Air Research in Early Chemistry",
      longText:
...
""",
      questions: [
        ...
        {
          'question':
              """9. Look at the four squares 1[■] that indicate where the following sentence could be added to the passage:
...
In the field of chemistry, the understanding of the word “air” has undergone radical change. Air for John Mayow, a seventeenth-century chemist, was essentially a receptacle for airborne particles, and through them manifested a variety of chemical properties. 2[■] But although Mayow and a few other chemists did detect specific chemical properties in what we call gases (including our carbon dioxide), most chemists left them unaccounted for until the beginning of the eighteenth century. 3[■] As chemists became aware that the atmosphere itself (and not just particles within it) had a role to play in combustion, r but rather to substances that air could absorb and release according to circumstances, and other reactions, they did not attribute this to the chemical properties of substances. [■] Thus, air provided a physical environment in which some reactions took place.
